...
@section('content')
    <div class="banner">
        <h2><a href="">Home</a><i class="fa fa-angle-right"></i><span>Faculties</span><i
                    class="fa fa-angle-right"></i><span>Show class</span></h2>
    </div>
    ...
    <div class="grid-form">
        ...
        <div class="content-top-1">
            <table class="table table-hover table-bordered">
                <h3 class="page-header">Classes Manage<a class="btn btn-sm btn-success pull-right"
                                                         href="{{route('classes.create')}}" title=""><i
                ...
                @if (isset($classes))
                    @foreach($classes as $key => $class)
                        <tr>
                            ...
                            <td><a class="btn btn-success btn-sm" href="{{route('classes.show', $class->id)}}">Show
                                    student</a></td>
